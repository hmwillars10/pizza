...
function cortarPizzas(){
	
  trozos=document.getElementById("trozos").value
  repartir = parseInt(trozos)
...
function draw() {//Función para pintar las pizzas 
  
  ellipseMode(CENTER)
  fill('#bd9a55')

  ellipse(200,200,150,150)//Pizza 1
  ellipse(mitadW, 200, 150, 150)//Pizza 2
  ellipse(windowWidth-200,200,150,150)//Pizza 3
  noLoop()
